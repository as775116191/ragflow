...
`,
    ...
    knowledgeConfiguration: {
      ...
      role: '特定角色',
      selectRoles: '选择角色',
      selectRolesTooltip: '选择可以访问此知识库的角色',
...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图的模块化检索增强生成 (RAG) 系统`,
      ...
      outlookSyncTitle: 'Outlook 邮箱同步',
      outlookSyncDescription: '自动同步您的 Outlook 邮箱中的邮件到此知识库。',
      outlookSync: '启用 Outlook 同步',
      outlookSyncTip: '启用后，系统将每12小时自动导入新邮件',
      outlookEmail: 'Outlook 邮箱',
      outlookEmailTip: '您的 Outlook 账户的邮箱地址',
      outlookEmailPlaceholder: '输入您的 Outlook 邮箱地址',
      outlookEmailFormatError: '请输入有效的邮箱地址',
      outlookEmailRequired: '启用同步时需要填写邮箱地址',
      outlookFolder: '邮件文件夹',
      outlookFolderTip: '需要同步的邮件文件夹（例如：收件箱、存档）',
      outlookFolderPlaceholder: '输入文件夹名称',
      outlookFolderRequired: '启用同步时需要填写文件夹名称',
      onedriveSync: '启用 OneDrive 同步',
      onedriveSyncTip: '启用后，系统将每12小时自动导入OneDrive中的新文件',
      onedriveEmail: '用户邮箱',
      onedriveEmailTip: '与您的OneDrive账户关联的电子邮件地址',
      onedriveEmailPlaceholder: '请输入您的电子邮件地址',
      onedriveEmailFormatError: '请输入有效的电子邮件地址',
      onedriveEmailRequired: '启用同步时邮箱是必填项',
      onedriveFolderPath: '文件夹路径',
      onedriveFolderPathTip: '从OneDrive同步的文件夹路径（从根目录开始）',
      onedriveFolderPathPlaceholder: '例如: Documents/Projects',
      onedriveFolderPathRequired: '启用同步时文件夹路径是必填项',
      syncNow: '立即同步',
      syncStarted: '同步已开始',
      syncFailed: '同步启动失败',
      ...
      syncCancelled: '同步已取消',
      cancelFailed: '取消同步失败',
      confirmCancelSync: '同步正在进行中，是否要取消？',
    },
    chunk: {
      chunk: '解析块',
      bulk: '批量',
    ...
    setting: {
      ...
      currentRoles: '当前角色',
      noRoles: '暂无角色',
      allRolesAssigned: '所有角色已绑定',
      availableRoles: '可用角色',
      roleAddFailed: '添加角色失败',
      roleRemoveFailed: '移除角色失败',
      roleAddedSuccess: '添加角色成功',
      roleRemovedSuccess: '移除角色成功',
      userRoles: '用户角色',
      teamStatus: '团队状态',
      owner: '拥有者',
      normal: '成员',
      ...
      modelsToBeAddedTooltip:
        '若您的模型供应商未列于此处，但宣称与 OpenAI 相容，可透过选择「OpenAI-API-compatible」卡片来设定相关模型。',
      ...
      resourceIdPlaceholder: '输入资源ID',
      resourceName: '资源名称',
      resourceNameRequired: '请输入资源名称',
      resourceNamePlaceholder: '输入资源名称',
      permissionType: '权限类型',
      permissionTypeRequired: '请选择权限类型',
      permissionTypePlaceholder: '选择权限类型',
      back: '返回列表',
      noMembers: '该角色暂无成员',
      noPermissions: '该角色暂无权限',
      nameRequired: '请输入名称',
