...
`,
    ...
    knowledgeConfiguration: {
      ...
      permissionsTip:
        "If it is set to 'Team', all your team members will be able to manage the knowledge base. If it is set to 'Role', only members with the selected role will have access.",
      chunkTokenNumberTip:
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
      ...
      outlookSyncTitle: 'Outlook Mail Sync',
      outlookSyncDescription:
        'Sync emails from your Outlook mailbox to this knowledge base automatically.',
      outlookSync: 'Enable Outlook Sync',
      outlookSyncTip:
        'When enabled, new emails will be automatically imported every 12 hours',
      outlookEmail: 'Outlook Email',
      outlookEmailTip: 'The email address of your Outlook account',
      outlookEmailPlaceholder: 'Enter your Outlook email address',
      outlookEmailFormatError: 'Please enter a valid email address',
      outlookEmailRequired: 'Email address is required when sync is enabled',
      outlookFolder: 'Mail Folder',
      outlookFolderTip: 'The folder to sync emails from (e.g., Inbox, Archive)',
      outlookFolderPlaceholder: 'Enter the folder name',
      outlookFolderRequired: 'Folder name is required when sync is enabled',
      onedriveSync: 'Enable OneDrive Sync',
      onedriveSyncTip:
        'When enabled, the system will automatically import new files from OneDrive every 12 hours',
      onedriveEmail: 'User Email',
      onedriveEmailTip:
        'The email address associated with your OneDrive account',
      onedriveEmailPlaceholder: 'Enter your email address',
      onedriveEmailFormatError: 'Please enter a valid email address',
      onedriveEmailRequired: 'Email is required when sync is enabled',
      onedriveFolderPath: 'Folder Path',
      onedriveFolderPathTip:
        'The OneDrive folder path to sync from (starting from root directory)',
      onedriveFolderPathPlaceholder: 'Example: Documents/Projects',
      onedriveFolderPathRequired:
        'Folder path is required when sync is enabled',
      syncNow: 'Sync Now',
      ...
      cancelFailed: 'Failed to cancel sync',
      confirmCancelSync: 'A sync is in progress. Do you want to cancel it?',
      role: 'Specific Role',
      selectRoles: 'Select Roles',
      selectRolesTooltip: 'Select roles that can access this knowledge base',
    ...
    setting: {
      ...
      roleAddFailed: 'Add role failed',
      roleRemoveFailed: 'Remove role failed',
      roleAddedSuccess: 'Add role success',
      roleRemovedSuccess: 'Remove role success',
      delete: 'Delete',
      roleDescription:
      ...
      resourceIdRequired: 'Please input resource ID',
      resourceIdPlaceholder: 'Enter resource ID',
      resourceName: 'Resource Name',
      resourceNameRequired: 'Please input resource name',
      resourceNamePlaceholder: 'Enter resource name',
      permissionType: 'Permission Type',
      permissionTypeRequired: 'Please select permission type',
      permissionTypePlaceholder: 'Select permission type',
      back: 'Back to list',
      noMembers: 'No members added to this role yet',
