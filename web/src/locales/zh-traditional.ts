...
以上就是你需要總結的內容。`,
 ...
 一般：實體和關係擷取提示來自 GitHub - microsoft/graphrag：基於模組化圖形的檢索增強生成 (RAG) 系統，`,
      ...
      outlookSyncTitle: 'Outlook 郵箱同步',
      outlookSyncDescription: '自動同步您的 Outlook 郵箱中的郵件到此知識庫。',
      outlookSync: '啟用 Outlook 同步',
      outlookSyncTip: '啟用後，系統將每12小時自動導入新郵件',
      outlookEmail: 'Outlook 郵箱',
      outlookEmailTip: '您的 Outlook 賬戶的郵箱地址',
      outlookEmailPlaceholder: '輸入您的 Outlook 郵箱地址',
      outlookEmailFormatError: '請輸入有效的郵箱地址',
      outlookEmailRequired: '啟用同步時需要填寫郵箱地址',
      outlookFolder: '郵件文件夾',
      outlookFolderTip: '需要同步的郵件文件夾（例如：收件箱、存檔）',
      outlookFolderPlaceholder: '輸入文件夾名稱',
      outlookFolderRequired: '啟用同步時需要填寫文件夾名稱',
    },
    chunk: {
      chunk: '解析塊',
      bulk: '批量',
    ...
    setting: {
      ...
      currentRoles: '當前角色',
      noRoles: '暫無角色',
      allRolesAssigned: '所有角色已綁定',
      availableRoles: '可用角色',
      roleAddFailed: '添加角色失敗',
      roleRemoveFailed: '移除角色失敗',
      ...
      user: '用戶',
      userRequired: '請選擇用戶',
      userPlaceholder: '輸入用戶ID或郵箱',
      addPermission: '添加權限',
      permissions: '權限',
      resourceId: '資源ID',
      resourceIdRequired: '請輸入資源ID',
      resourceIdPlaceholder: '輸入資源ID',
      resourceName: '資源名稱',
      resourceNameRequired: '請輸入資源名稱',
      resourceNamePlaceholder: '輸入資源名稱',
      permissionType: '權限類型',
      permissionTypeRequired: '請選擇權限類型',
      permissionTypePlaceholder: '選擇權限類型',
      back: '返回列表',
      noMembers: '該角色暫無成員',
      noPermissions: '該角色暫無權限',
      nameRequired: '請輸入名稱',
